...
const Header = ({ onRegisterClick }: HeaderProps) => {
    return (
        <header className="relative min-h-screen flex flex-col items-center text-center px-4 overflow-hidden">
            ...
            <div className="flex-shrink-0 relative z-10 flex flex-col items-center justify-center gap-4 pb-6">
