            ...
            <div className="relative z-10 space-y-6">
                ...
                <div className="flex justify-center pt-4">
                    <button 
                        ...
                        className="bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg shadow-red-500/20"
                    >
                        Register Now
                    </button>
                </div>
